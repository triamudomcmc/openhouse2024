...
export const getStaticPaths: GetStaticPaths = async ({}) => {
  const raw = JSON.parse(
    fs.readFileSync(`./src/_data/_maps/clubs.json`, {
      encoding: "utf-8",
    })
  );
  let tmp = [];
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  finalData["ClubArticle"] = raw[clubId].clubsactivity ?? "";
  finalData["Advantage"] = raw[clubId].benefits ?? "";
  finalData["Work"] = raw[clubId].workings ?? "";
  finalData["Review1"] =
    {
              ...
              <div className=" lg:w-1/2 md:w-2/3 z-30 lg:mt-[15%] md:mt-[20%] sm:mt-[25%] pb-[200px] md:pb-[700px] ">
                ...
                <div className=" w-full flex  justify-center gap-4 items-center md:mt-5  ">
                  ...
                  <div className=" md:w-[200px] w-[150px]">
                    <p className=" flex text-[#8133A7] md:w-[200px] w-[150px] text-xl font-Thai break-normal ">
                      {" "}
                    ...
                    {contacts.others && contacts.others.trim() != "" && (
                      <p className=" flex text-[#8133A7] md:w-[200px] w-[150px] text-xl font-Thai break-normal whitespace-pre-line ">
