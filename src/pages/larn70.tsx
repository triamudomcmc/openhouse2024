        ...
        <div className="  lg:pt-20 mb-10 relative z-[99] max-md:px-3  ">
          <div className="">
            ...
            <div className=" space-y-6 block mt-5 ">
              ...
              {shows("9.00-9.30", "การสัมภาษณ์รองฯ กลุ่มบริหารวิชาการ")}
              ...
              {shows("12.30-13.00", "การสัมภาษณ์ตัวแทนนักเรียน\nศิลป์ตะวันตก")}
          ...
          <div className="">
            ...
            <div className=" space-y-6 block mt-5 ">
              ...
              {shows("9.10-9.40", "การสัมภาษณ์ตัวแทน\nนักเรียนศิลป์คำนวณ")}
              {shows("9.45-9.55", "การแสดงเต้นเพลงจีน")}
              {shows("10.00-10.30", "การแสดงละครรำ")}
              {shows("10.35-11.05", "การสัมภาษณ์ตัวแทน\nนักเรียนศิลป์ตะวันออก")}
              {shows("11.10-11.15", "การแสดงโซรัน")}
              {shows("11.20-11.50", "การสัมภาษณ์ตัวแทน\nนักเรียนวิทย์-คณิต")}
