...
export const getStaticPaths: GetStaticPaths = async ({}) => {
  const raw = JSON.parse(
    fs.readFileSync(`./src/_data/_maps/programmes.json`, {
      encoding: "utf-8",
    })
  );
  let tmp = [];
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  finalData["ClubArticle"] = raw[clubId].admission ?? "";
  finalData["Advantage"] = raw[clubId].subjects ?? "";
  finalData["Work"] = raw[clubId].interests ?? "";
  finalData["Review1"] =
    {
  ...
  finalData["reviewImageUrl"] = {
    first:
      ...
      `/assets/images/programmes/${clubId}-first-default.jpg`,
    second:
      raw[clubId].imgprofile2 ??
      `/assets/images/programmes/${clubId}-second-default.jpg`,
    third:
      raw[clubId].imgprofile3 ??
      `/assets/images/programmes/${clubId}-third-default.jpg`,
  };
            ...
            <div className=" flex justify-center w-full   bg-gradient-to-b from-[#FFF9E9] to-[#C0B0FF] from-70% to-100%">
              <div className=" lg:w-1/2 md:w-2/3 z-30 lg:mt-[15%] md:mt-[20%] sm:mt-[25%] pb-[700px]">
                ...
                <div className=" flex justify-center gap-3 lg:mt-10">
                  <div className="  font-semibold text-transparent bg-clip-text bg-gradient-to-b from-[#7533A8] to-[#D62C9F] font-Thai text-right min-w-52 text-4xl py-5 hidden lg:block ">
                    การรับสมัคร
                      ...
                      <div className=" md:w-full sm:w-[90%]  mt-10 bg-gradient-to-b from-[#112881]/[.90] to-[#8E297A]/[.50] mx-auto   flex p-4 rounded-3xl min-h-30 gap-5">
                        <div className=" relative z-10  min-w-[30%] w-[30%] md:min-w-[25%] md:w-[25%] lg:min-w-[20%] lg:w-[20%] ">
                          ...
                          <div className=" block md:mt-1  z-50 relative">
                            <p className=" text-white md:text-2xl sm:text-md min-h-[28px] font-semibold  break-words  bg-transparent font-Thai">
                              {review1.name}
                            </p>
