        ...
        <div className=" flex justify-center  ">
          <div className=" flex mt-16 w-3/4 md:w-1/2 lg:w-1/3 border border-slate-500 rounded-lg justify-center align-middle flex-wrap bg-white bg-opacity-50">
            ...
            <div className=" w-3/5 flex align-middle justify-center items-center">
              <FormControl>
                <FormLabel id="demo-radio-buttons-group-label" className="">
                  ประเภท
                </FormLabel>
                <RadioGroup
                ...
                >
                  ...
                  />
                  <FormControlLabel
                    value="โครงการพัฒนาความสามารถ"
                    control={<Radio />}
                    label="โครงการพัฒนาความสามารถ"
                  />
                  <FormControlLabel
                    value="องค์กรนักเรียน"
                    control={<Radio />}
            ...
            <div
              className={
                program
                  ? "w-full flex align-middle justify-center my-5"
                  : " hidden"
              }
            >
              <FormControl sx={{ m: 1, minWidth: 200 }}>
                ...
                <Select
                  ...
                  defaultValue=""
                >
                  <MenuItem value="สายการเรียนวิทยาศาสตร์-คณิตศาสตร์">
                    วิทยาศาสตร์-คณิตศาสตร์
                  </MenuItem>
                  <MenuItem value="สายการเรียนภาษา-คณิตศาสตร์">
                    ภาษา-คณิตศาสตร์
                  </MenuItem>
                  <MenuItem value="สายการเรียนภาษา-ภาษาฝรั่งเศส">
                    ภาษา-ภาษาฝรั่งเศส
                  </MenuItem>
                  <MenuItem value="สายการเรียนภาษา-ภาษาเยอรมัน">
                    ภาษา-ภาษาเยอรมัน
                  </MenuItem>
                  <MenuItem value="สายการเรียนภาษา-ภาษาญี่ปุ่น">
                    ภาษา-ภาษาญี่ปุ่น
                  </MenuItem>
                  <MenuItem value="สายการเรียนภาษา-ภาษาจีน">
                    ภาษา-ภาษาจีน
                  </MenuItem>
                  <MenuItem value="สายการเรียนภาษา-ภาษาสเปน">
                    ภาษา-ภาษาสเปน
                  </MenuItem>
                  <MenuItem value="สายการเรียนภาษา-ภาษาเกาหลี">
                    ภาษา-ภาษาเกาหลี
                  </MenuItem>
                </Select>
              </FormControl>
            ...
            >
              <FormControl sx={{ m: 1, minWidth: 200 }}>
                ...
                <Select
                  ...
                  defaultValue=""
                >
                  <MenuItem value="โครงการพัฒนาความสามารถพิเศษด้านคณิตศาสตร์">
                    ความสามารถพิเศษด้านคณิตศาสตร์
                  </MenuItem>
                  <MenuItem value="โครงการพัฒนาความสามารถพิเศษด้านวิทยาศาสตร์">
                    ความสามารถพิเศษด้านวิทยาศาสตร์
                  </MenuItem>
                  <MenuItem value="โครงการพัฒนาความสามารถพิเศษด้านภาษาอังกฤษ">
                    ความสามารถพิเศษด้านภาษาอังกฤษ
                  </MenuItem>
                  <MenuItem value="โครงการพัฒนาความสามารถพิเศษด้านภาษาไทย">
            ...
            >
              <FormControl sx={{ m: 1, minWidth: 200 }}>
                ...
                <Select
                  ...
                  defaultValue=""
                >
                  <MenuItem value="คณะกรรมการนักเรียน (กน.)">
                    คณะกรรมการนักเรียน
                  </MenuItem>
                  <MenuItem value="นักเรียนผู้ช่วยงานประชาสัมพันธ์ (ปชส.)">
                    นักเรียนผู้ช่วยงานประชาสัมพันธ์
                  </MenuItem>
                  <MenuItem value="กลุ่มนักเรียน AIC (กอ.)">
                    กลุ่มนักเรียนเอไอซี
                  </MenuItem>
                </Select>
              </FormControl>
            ...
            >
              <FormControl sx={{ m: 1, minWidth: 200 }}>
                <InputLabel id="demo-simple-select-autowidth-label" disabled>
                  สายการเรียน
                </InputLabel>
                <Select
                  labelId="demo-simple-select-autowidth-label"
