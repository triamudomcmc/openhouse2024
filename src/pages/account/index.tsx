      ...
      <div className=" absolute top-1/2 -translate-y-1/2 lg:right-1/3 lg:translate-x-1/3 md:right-1/4 md:translate-x-1/4 sm:right-1/2 sm:translate-x-1/2 z-50">
        ...
        <div>
          { username !=="" && <motion.div
            ...
            className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF53C5] from-0% to-[#FFFBE7] to-100% lg:text-7xl md:text-6xl sm:text-5xl font-Figerona font-bold w-fit text-shadow-glow "
          >
            {username}
          </motion.div>}
        </div>
