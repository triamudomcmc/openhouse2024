...
export default function RegisterOPHNFC3() {
  ...
  return (
    <div className=" min-h-screen flex justify-center items-center w-full h-screen bg-[#FCF7E1]">
      <div className=" block">
        <div className=" flex justify-center">
        <svg
          aria-hidden="true"
          className="inline w-20 text-white animate-spin dark:text-white fill-[#7625B9]"
          viewBox="0 0 100 101"
          fill="none"
        ...
        <div className=" mt-5 text-[#7625B9]">กำลังลงทะเบียน</div>
      </div>
    </div>
  );
}
