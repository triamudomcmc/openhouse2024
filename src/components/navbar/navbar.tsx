      ...
      <nav className=" max-md:hidden bg-[#935AE3] bg-opacity-90 flex align-middle  justify-between gap-10 text-center z-20 top-0 h-16 text-white ">
        ...
        <div className="flex w-full justify-end lg:gap-[60px] md:gap-5 mr-[60px] h-full items-center lg:text-base md:text-sm ">
          ...
          >
            ...
            {showShows && (
              <motion.div
                className=" absolute block top-9 -left-[25px]  shadow-xl py-2  w-40  bg-[#774CB4]  rounded-xl text-center"
              ...
              >
                <Link
                  href="/theatre"
                  className=" block w-full  font-normal px-2 pb-2 border-b"
                  onClick={() => {
                    setShowShows(false);
                    setShowOther(false);
                  }}
                ...
                <Link
                  href="/larn70"
                  className=" block w-full  font-normal mt-2 px-2"
                  onClick={() => {
                    setShowShows(false);
                    setShowOther(false);
                  }}
