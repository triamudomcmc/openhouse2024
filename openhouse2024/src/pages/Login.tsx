  ...
  useEffect(() => {
    ...
    return (
      ...
      <div className="overflow-hidden relative w-full hidden lg:block h-screen bg-gradient-to-r from-[#2E1A56] to-[#381B5B]  -z-10">
        ...
        <div className=" absolute max-lg:flex max-lg:items-center max-lg:justify-center max-lg:h-screen z-10 max-lg:left-1/2 max-lg:-translate-x-1/2 lg:bottom-72  lg:right-60 lg:mr-10">
       ...
       <div className="hidden lg:block absolute top-0 left-10 h-screen overflow-hidden">
        ...
        <div className="hidden lg:block absolute top-60 left-40 text-right ">
        <Register />
        </div>
