      ...
      <div className=" bg-[#5A2561] h-[4600px] w-full ">
        ...
        <div className=" flex justify-center z-0">
          ...
          <div className=" absolute mt-32 top-96 flex justify-center">
            ...
            <p className="  text-center mt-12 font-Thai text-3xl py-5">
              {clubsE}
            </p>
          ...
          <p className=" absolute top-96 lg:mr-[600px] lg:mt-[600px] hidden lg:flex px-6 w-60 py-5  gap-2 font-semibold text-transparent bg-clip-text bg-gradient-to-b from-[#D738A4] to-[#FFDD77] font-Thai text-6xl ">
            ชมรมนี้
          </p>
          <p className=" absolute top-96 lg:mr-[660px] lg:mt-[660px] hidden lg:flex px-14 w-60 py-5 gap-2 font-semibold  text-transparent bg-clip-text bg-gradient-to-b from-[#D738A4] to-[#FFDD77] font-Thai text-4xl ">
            ทำอะไร
          </p>
          <p className=" absolute top-96 w-[200px] mt-[547px] leading-loose md:mr-[550px] sm:mr-[0px] font-semibold text-transparent bg-clip-text bg-gradient-to-b from-[#D738A4] to-[#FFDD77] font-Thai  text-3xl  lg:hidden ">
            ชมรมนี้ทำอะไร ?
          </p>
          <svg
        ...
        <div className=" absolute top-96 inset-0 m-auto  lg:mt-[920px] mt-[1150px] flex justify-center">
          ...
          <p className=" absolute top-96 md:mt-[0px] leading-loose md:mr-[350px] font-semibold text-transparent bg-clip-text bg-gradient-to-b from-[#D738A4] to-[#FFDD77] font-Thai  md:text-3xl text-2xl  lg:hidden ">
