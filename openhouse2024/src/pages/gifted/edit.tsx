    ...
    <>
      <div className=" bg-[#5A2561] h-[4600px] w-full ">
        ...
        <div className=" flex justify-center z-0">
          ...
          <p className=" absolute top-96 lg:mr-[600px] lg:mt-[600px] hidden lg:flex px-6 w-80 py-5  gap-2 font-semibold text-transparent bg-clip-text bg-gradient-to-b from-[#D738A4] to-[#FFDD77] font-Thai text-5xl ">
            การรับสมัคร และ
          </p>
          <p className=" absolute top-96 lg:mr-[660px] lg:mt-[690px] hidden lg:flex px-14 w-80 py-5 gap-2 font-semibold  text-transparent bg-clip-text bg-gradient-to-b from-[#D738A4] to-[#FFDD77] font-Thai text-3xl ">
            การสอบเข้า
          </p>
