      ...
      <>
        ...
        <div className=" flex justify-center z-0">
            ...
            <div className=" flex text-white md:w-[450px] sm:w-[450px] sm:-ml-[15px] md:ml-[5px] left-1/2 absolute -translate-x-1/2  font-Thai mt-[200px] justify-between ">
              ...
              <p className=" text-4xl block text-center text-transparent  bg-clip-text bg-gradient-to-b from-[#632790] to-[#D738A4]">สมาชิก <br />
        ...
        <div className={showReview2 ? " absolute top-96 lg:mt-[1910px] md:mt-[2500px] sm:mt-[2410px] sm:w-[500px] px-12 py-5 flex gap-2 md:w-[850px] text-white font-Thai " : "hidden"}>
              <ReviewCardR/>
        </div>

        <div className={showReview3 ? " absolute top-96 lg:mt-[2310px] md:mt-[2900px] sm:mt-[2710px] sm:w-[500px] px-12 py-5 flex gap-2 md:w-[850px] text-white font-Thai " : "hidden"}>
              <ReviewCard3/>
        </div>
        ...
        <div className=" absolute top-96 inset-0 m-auto  lg:mt-[970px] md:mt-[1200px] sm:mt-[900px] flex justify-center">
          <p className=" text-[#582A88]  text-lg break-words font-Thai h-60 sm:ml-10 md:w-[750px] sm:w-[600px] md:h-72 sm:h-[500px] bg-transparent align-top resize-none overflow-y-scroll  whitespace-pre-line" >{admission}
            </p>
        </div>       

        <div className=" absolute top-96 inset-0 m-auto  lg:mt-[1710px] md:mt-[2200px] sm:mt-[1900px] flex justify-center">
          <p className=" text-[#582A88] text-lg break-words font-Thai h-60 sm:ml-10 md:w-[750px] sm:w-[600px] md:h-72 sm:h-[500px] bg-transparent align-top resize-none overflow-y-scroll whitespace-pre-line" >{subjects}
        ...
        <div className=" absolute top-96 inset-0 m-auto  lg:mt-[2430px] md:mt-[3200px] sm:mt-[2900px] flex justify-center">
          <p className=" text-[#582A88] text-lg break-words  font-Thai h-60 sm:ml-10 md:w-[750px] sm:w-[600px] md:h-72 sm:h-[500px] bg-transparent align-top resize-none overflow-y-scroll whitespace-pre-line" >{interests}
        ...
        <div className=" absolute top-96 inset-0 m-auto  lg:mt-[2895px] md:mt-[3730px] sm:mt-[3790px] flex justify-center">
            ...
            <p className=" text-white  text-md break-words font-Thai  md:w-[480px] md:ml-[240px] md:h-[266px] sm:w-[250px] sm:ml-[140px] sm:h-[120px] bg-transparent align-top resize-none overflow-y-scroll whitespace-pre-line" >{review1}
            </p>
        </div>
        ...
        <div className=" absolute top-96 inset-0 m-auto  lg:mt-[2900px] md:mt-[3730px] sm:mt-[3790px] md:mr-[485px] sm:mr-[180px]  flex justify-center">
          ...
          <img className="absolute top-0 ml-0 lg:ml-[0px] lg:mt-[0px] md:mt-[0px] z-10  flex object-cover md:h-[153px] md:w-[153px] sm:h-[80px] sm:w-[80px] rounded-3xl " src={`data:${review1ProfileType};base64,${review1Profile}`} />
          <div className=" block md:mt-1 ">
              ...
              <div className=" absolute top-96 inset-0 m-auto  lg:mt-[3295px] lg:mr-0 md:mt-[4115px] sm:mt-[4090px] md:mr-[270px] flex justify-center">
                <p className=" text-white text-md break-words font-Thai  md:w-[480px] md:mr-[240px] md:h-[266px] sm:w-[250px] sm:mr-[130px] sm:h-[120px] bg-transparent align-top resize-none overflow-y-scroll whitespace-pre-line" >{review2}
                </p>
              ...
              <div className=" absolute top-96 inset-0 m-auto  lg:mt-[3300px] md:mt-[4120px] sm:mt-[4090px] md:ml-[550px] sm:ml-[280px] flex justify-center">
                ...
                <img className="absolute top-0 ml-0 lg:ml-[0px] lg:mt-[0px] md:mt-[0px] z-10  flex object-cover md:h-[153px] md:w-[153px] sm:h-[80px] sm:w-[80px] md:rounded-3xl sm:rounded-2xl " src={`data:${review2ProfileType};base64,${review2Profile}`} />
              </div>
                  <div className=" block md:mt-1">
          ...
          <p className=" text-white  text-md break-words font-Thai  md:w-[480px] md:ml-[240px] md:h-[266px] sm:w-[250px] sm:ml-[140px] sm:h-[120px] bg-transparent align-top resize-none overflow-y-scroll whitespace-pre-line" >{review3}
          </p>
        </div>
        <div className=" absolute top-96 inset-0 m-auto  lg:mt-[3700px] md:mt-[4520px] sm:mt-[4390px] md:mr-[485px] sm:mr-[180px] flex justify-center">
          ...
          <img className="absolute top-0 ml-0 lg:ml-[0px] lg:mt-[0px] md:mt-[0px] z-10  flex object-cover md:h-[153px] md:w-[153px] sm:h-[80px] sm:w-[80px]  rounded-3xl " src={`data:${review3ProfileType};base64,${review3Profile}`} />
                  <div className=" block md:mt-1 ">
