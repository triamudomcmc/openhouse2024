    ...
    <>
      <div className=" bg-[#5A2561] h-[4600px] w-full ">
        ...
        <div className=" flex justify-center z-0">
          ...
          <p className=" absolute top-96 lg:mr-[550px] lg:mt-[690px] hidden lg:flex px-14 w-80 py-5 gap-2 font-semibold  text-transparent bg-clip-text bg-gradient-to-b from-[#D738A4] to-[#FFDD77] font-Thai text-3xl ">
            การสอบเข้า
          </p>
        ...
        <div className=" absolute top-96 inset-0 m-auto  lg:mt-[920px] mt-[1150px] flex justify-center">
          ...
          <div className=" absolute top-96 lg:mt-[1400px] md:mt-[2000px] sm:mt-[2000px] px-12 py-5 flex gap-2 lg:w-1/2 w-full  text-white font-Thai ">
            <ReviewWidget />
          </div>
        ...
        <div className=" absolute top-96 inset-0 m-auto   lg:mt-[970px] md:mt-[1200px] sm:mt-[900px] flex justify-center">
          ...
          ></textarea>
          <button className="md:ml-10  " onClick={turnOnAdmissionEditMode}>
            <PencilIcon />
          </button>
        </div>
        ...
        <div className=" absolute top-96 inset-0 m-auto  lg:mt-[1710px] md:mt-[2200px] sm:mt-[1900px] flex justify-center">
          ...
          ></textarea>
          <button className="md:ml-10" onClick={turnOnSubjectsEditMode}>
            <PencilIcon />
          </button>
        </div>
        ...
        <div className=" absolute top-96 inset-0 m-auto  lg:mt-[2430px] md:mt-[3200px] sm:mt-[2900px] flex justify-center">
          ...
          ></textarea>
          <button className="md:ml-10" onClick={turnOnInterestsEditMode}>
            <PencilIcon />
          </button>
        </div>
